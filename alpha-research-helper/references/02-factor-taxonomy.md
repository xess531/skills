...
## 附录：WQ101 / GTJA191 因子编号对照

> 上述各因子类别对应 WQ101、GTJA191 的具体编号映射，详见 `references/09-factor-cross-reference.md`。该文件按投资逻辑（量价关系、动量/反转、波动率、价格形态、统计套利、基本面代理）提供了 292 个因子编号的完整交叉对照表。
